      ...
      <div className="max-w-[1440px] mx-auto">
        <div className="flex flex-col md:flex-row gap-10 md:gap-16 lg:gap-24">
          <div className="flex-1">
            <p className="font-grotesque font-black text-sm text-milk mb-3">Design Factory by Telesoftas</p>
          ...
          <div className="md:text-right">
            ...
            <p className="font-inter text-xs text-white/42 mt-1">&copy; 2026 Design Factory by Telesoftas</p>
          </div>
        </div>
      </div>
    </footer>
